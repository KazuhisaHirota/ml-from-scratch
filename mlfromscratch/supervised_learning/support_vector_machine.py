...
class SupportVectorMachine(object):
    ...
    power: int. The degree of the polynomial kernel.
    gamma: float. Used in the rbf kernel function.
    coef: float. Bias term used in the polynomial kernel function.
    """
    ...
    def fit(self, X, y):
        ...
        # Initialize kernel function with parameters
